...
**Last Updated**: 2026-07-23 — CRAN column now uses `img.shields.io/cran/v/<pkg>` for all 6 packages (was a mix of live `r-pkg.org` badges for CRAN-published packages and hand-typed "Not on CRAN" text for the rest; `r-pkg.org` also 404s with broken HTML, not a valid image, for not-yet-published packages)
