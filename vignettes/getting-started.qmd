...
`mediationverse_sitrep()` prints a situation report of all ecosystem packages,
their versions, and installation sources — useful for diagnosing missing or
outdated packages.
...
|---------|-------|---------------|
| probmed | Effect sizes | `pmed()` |
| RMediation | Confidence intervals | `ci()`, `medci()`, `mbco()` |
| medrobust | Sensitivity | `bound_ne()` |
| medsim | Simulation | `medsim_run()` |
