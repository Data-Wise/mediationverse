...
1. **Go to GitHub**: https://github.com/organizations/data-wise/repositories/new

2. **Repository Settings**:
   - Repository name: `mediationverse`
   - Description: `Meta-package for the mediation analysis ecosystem in R`
   - Visibility: Public
...
**Local**: `~/packages/mediationverse/`
**GitHub**: https://github.com/data-wise/mediationverse (to be created)
